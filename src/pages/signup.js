...
const SignupPage = () => {
  ...
  return (
    <div className="">
      <img className={style.wave} src="/images/wave.png" />
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                ...
                <div className="mt-6">
                  <button
                    ...
                    className={
                      disabled
                        ? 'w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#73827d] rounded-md hover:bg-[#637c74] focus:outline-none focus:bg-[#21ad7e]"'
                        : "w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#32BD8F] rounded-md hover:bg-[#32BD8F] focus:outline-none focus:bg-[#21ad7e]"
                    }
                  >
                    Sign Up
                  </button>
