    ...
    return (
        <div className=''>
            {/* <form onSubmit={handleSubmit((data) => console.log(data))}>
                <input {...register('firstName')} type='text' style={{ border: '1px solid red' }} />
                <input {...register('lastName', { required: true })} style={{ border: '1px solid red' }} />
                    ...
                    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
                        <div className="w-full p-6 m-auto bg-white rounded-md border lg:max-w-xl">
                            ...
                            <form className="mt-6">
                                ...
                                <div className="mt-6">
                                    <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-[#32BD8F] rounded-md hover:bg-[#32BD8F] focus:outline-none focus:bg-[#21ad7e]">
                                        Login
                                    </button>
                                </div>
                            </form>
